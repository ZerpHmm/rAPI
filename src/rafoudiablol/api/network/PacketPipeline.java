	...
	implements IPacketManager
{
	...
	private final BaseForgeMod modObj;
	
	public PacketPipeline(BaseForgeMod mod)
	{
		modObj = mod;
	}
	...
	protected void encode(ChannelHandlerContext ctx, AbstractPacket msg, List<Object> out) throws Exception {
		...
		msg.encodeInto(new PacketBuffer(buffer));
	...
	protected void decode(ChannelHandlerContext ctx, FMLProxyPacket msg, List<Object> out) throws Exception {
		...
		pkt.decodeInto(new PacketBuffer(payload.slice()));

		switch (FMLCommonHandler.instance().getEffectiveSide()) {
		case CLIENT:
			pkt.handleClientSide((EntityPlayerSP)this.getClientPlayer());
			break;
	...
	public void initalize() {
		this.channels = NetworkRegistry.INSTANCE.newChannel(modObj.getModAnnotation().modid(), this);
	}
